...
const SignupInfo = memo(() => {
  ...
  React.useEffect(() => {
    if (CompleteState.complete) {
      if (
        data.rt === 200 &&
        window.confirm("입력하신 내용으로 정보가 저장됩니다.계속하시겠습니까?")
      ) {
  ...
  //가입하기버튼 submit
  const SignupInfoSubmit = React.useCallback(
    (e) => {
      e.preventDefault();
      ...
      try {
        ...
        RegexHelper.minLength(
          current.userpw,
          8,
          "비밀번호는 8글자 이상만 입력 가능합니다"
        );
        RegexHelper.maxLength(
          current.userpw,
          20,
          "비밀번호는 최대 20글자 까지 입력 가능합니다"
        );
        //비밀번호 확인
        ...
        RegexHelper.minLength(
          current.username,
          2,
          "이름은 2글자 이상 부터 입력 가능합니다"
        );
        RegexHelper.maxLength(
          current.username,
          20,
          "이름은 최대 20글자 까지 입력 가능합니다"
        );
        RegexHelper.korEng(
          current.username,
          "이름은 한글,영문만 입력 가능합니다"
  ...
  //중복검사이벤트
  const idInfoSubmit = React.useCallback(
    (e) => {
      e.preventDefault();
          ...
          <form onSubmit={SignupInfoSubmit}>
            <div className="signup-info-div-box">
              ...
              <div className="signup-info-div3">
                <button onClick={idInfoSubmit}>중복확인</button>
              </div>
            </div>
            <div className="signup-info-div-box">
              <div className="signup-info-div1">
            ...
            <div className="signup-info-div-box">
              ...
              <div className="signup-info-div2">
                <input
                  ...
                  name="zonecode"
                  placeholder="우편번호"
                  defaultValue={daumJuso.zonecode}
                />
              </div>
              <div className="signup-info-div3">
