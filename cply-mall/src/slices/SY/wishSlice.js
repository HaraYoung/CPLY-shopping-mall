...
const API_URL = 'http://localhost:3001/likes/';

/** 다중행 데이터 조회를 위한 비동기 함수 */
export const getList = createAsyncThunk('wishSlice/getList', async (payload, { rejectWithValue }) => {
    let result = null;
...
/** 데이터 저장을 위한 비동기 함수 */
export const postItem = createAsyncThunk('wishSlice/postItem', async (payload, { rejectWithValue }) => {
    let result = null;
