...
export const getList = createAsyncThunk('CartSlice/getList', async (payload, { rejectWithValue }) => {
    let result = null;
...
/** 데이터 저장을 위한 비동기 함수 */
export const postItem = createAsyncThunk('CartSlice/postItem', async (payload, { rejectWithValue }) => {
    let result = null;
...
/** 데이터 수정을 위한 비동기 함수 */
export const putItem = createAsyncThunk('CartSlice/putItem', async (payload, { rejectWithValue }) => {
    let result = null;
...
/** 데이터 삭제를 위한 비동기 함수 */
export const deleteItem = createAsyncThunk('CartSlice/deleteItem', async (payload, { rejectWithValue }) => {
    let result = null;
